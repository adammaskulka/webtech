...
<head>
    ...
    <title>Prvé zadanie Adam Maškulka</title>
</head>
<body>
<header class="navbar navbar-inverse navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Prvé zadanie Adam Maškulka</a>
        </div>
    </div>
</header>
<div class="container-fluid">
    <h2 class="col-lg-offset-1">Kalendár dochádzky na tento mesiac</h2>
    ...
    <?php
    if (isset($_GET["mesiac"]) && isset($_GET["rok"])) {
        generate_table(htmlspecialchars($_GET["mesiac"]), htmlspecialchars($_GET["rok"]));
    } else {
        generate_table(date('m'), date('Y'));
    }
...
<script type="application/javascript">
    ...
    function mousemove(e) {
        if (mouse == true && click == true && FLAG == true) {
            click = false;
            setTimeout(function(){ console.log(e); click = true;}, 10);
